...
struct Recipes: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            VStack {
                let firstTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.030, weight: .semibold, design: .rounded), color: AppConstants.black)]
                
                Text(detail?.strMeal ?? AppConstants.emptyString)
                    .configure(withModifier: firstTextModifier)
                
                let secondTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.023, weight: .regular, design: .rounded), color: AppConstants.darkGrayOne)]
            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                HStack {
                    let firstTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.025, weight: .semibold, design: .rounded), color: AppConstants.black)]
                    ...
                    let secondTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.020, weight: .regular, design: .rounded), color: AppConstants.green)]
                    ...
                    if isShowDetailsForIngredients {
                        if let ingredientsWithMeasures = detail?.strIngredientsWithMeasures {
                            ForEach(Array(ingredientsWithMeasures.enumerated()), id: \.1.key) { index, keyValue in
                                ...
                                HStack {
                                    let firstTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.020, weight: .light, design: .rounded), color: AppConstants.black)]
                                    ...
                                    let secondTextModifier = [TextModifier(font: .system(size: geometry.size.height * 0.020, weight: .regular, design: .rounded), color: AppConstants.black)]
                    ...
                    VStack(spacing: 25.0) {
                        Button(action: {
                            ...
                            HStack {
                                ...
                                let textModifier = [TextModifier(font: .system(size: geometry.size.height * 0.020, weight: .semibold, design: .rounded), color: AppConstants.green)]
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 10.0)
                                    ...
                                    .frame(width: geometry.size.width - 30.0, height: geometry.size.height * 0.065)
                            }
